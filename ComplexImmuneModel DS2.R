...
plot(WtMeanNTime$WTmean~WtMeanNTime$Time,xlim=c(0,30),type='s',xlab='',ylab='',main='DS',cex.main=3,cex.axis=2,ylim=c(min(LAll),max(LAll)))
...
plot(WtMeanNTime$LengthDom~WtMeanNTime$Time,xlim=c(0,30),type='s',xlab='',ylab='',main='DS',cex.main=3,cex.axis=2,ylim=c(min(LAll),max(LAll)))
